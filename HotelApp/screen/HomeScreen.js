...
import { fetchData } from "../feature/hotelsSlice";
...
const HomeScreen = ({navigation, onPress}) => {
  ...
  useEffect(() => {
    ...
    const categories = ['Populer destinasi'];
    ...
    const Card = ({hotel, index}) => {
        ...
        <TouchableOpacity
            ...
            <Image source={require(`../assets/img-hotel/${hotel.poto_hotel}`)} style={style.cardImage} />
        ...
        <View style={style.header}>
          <View style={{paddingBottom: 15}}>
            ...
            <View style={{flexDirection: 'row'}}>
              <Text style={{fontSize: 30, fontWeight: 'bold'}}>di </Text>
              <Text
          ...
          {(() => {
            ...
            return(
              <Icon1 name="user" size={38} color={COLORS.grey} />
            )
            }else{
              return(
                <Icon1 name="sign-in-alt" size={38} color={COLORS.grey} 
